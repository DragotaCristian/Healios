...
WebUI.setText(findTestObject('Object Repository/Page_Healios Platform/input_Role Name___BVID__1238'), '1234567890ABCDEFGHIJ1234567890ABCDEFGHIJ1234567890ABCDEFGHIJ1234567890ABCDEFGHIJ1234567890ABCDEFGHIJEND')

WebUI.delay(2)

testText = WebUI.getAttribute(findTestObject('Page_Healios Platform/input_Role Name___BVID__1238'), 'value')

assert testText.length() <= 100
