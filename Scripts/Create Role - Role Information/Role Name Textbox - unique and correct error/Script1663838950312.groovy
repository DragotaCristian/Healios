...
WebUI.setText(findTestObject('Object Repository/Page_Healios Platform/input_Role Name___BVID__1238'), 'test')
...
error = WebUI.getText(findTestObject('Page_Healios Platform/ErrorToast'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyEqual(error, 'The role name is already in use')
