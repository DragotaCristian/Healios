...
not_run: WebUI.click(findTestObject('Object Repository/Page_Healios Platform/div_Role Name'))

WebUI.setText(findTestObject('Object Repository/Page_Healios Platform/input_Role Name___BVID__1238'), 'random name')

WebUI.delay(2)

WebUI.setText(findTestObject('Page_Healios Platform/textarea_Description_textarea'), '')

testText = WebUI.getAttribute(findTestObject('Page_Healios Platform/textarea_Description_textarea'), 'value')

assert testText.length() <= 400
