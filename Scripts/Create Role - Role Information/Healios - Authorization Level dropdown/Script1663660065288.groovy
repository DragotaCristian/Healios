...
WebUI.verifyElementText(findTestObject('Page_Healios Platform/Role_Healios'), 'Healios')
...
WebUI.verifyElementText(findTestObject('Page_Healios Platform/AuthType - System'), 'System')

WebUI.click(findTestObject('Page_Healios Platform/AuthType - System'))
