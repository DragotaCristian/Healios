...
WebUI.setText(findTestObject('Page_Healios Platform/input_Role Type_vs__search'), 'Client')

WebUI.sendKeys(findTestObject('Page_Healios Platform/input_Role Type_vs__search'), Keys.chord(Keys.ENTER))

not_run: WebUI.setText(findTestObject('Page_Healios Platform/input_Role Type_vs__search'), 'notthere')

not_run: WebUI.verifyElementVisible(findTestObject('Page_Healios Platform/li_Sorry, no matching options'), FailureHandling.CONTINUE_ON_FAILURE)
