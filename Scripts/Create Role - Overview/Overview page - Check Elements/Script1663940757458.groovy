...
WebUI.verifyElementText(findTestObject('Object Repository/Page_Healios Platform/p_Role Information'), 'Role Information')

WebUI.verifyElementText(findTestObject('Object Repository/Page_Healios Platform/p_Role Type'), 'Role Type')

WebUI.verifyElementText(findTestObject('Object Repository/Page_Healios Platform/p_Authorisation Level'), 'Authorisation Level')

WebUI.verifyElementText(findTestObject('Object Repository/Page_Healios Platform/p_Role Name'), 'Role Name')

WebUI.verifyElementText(findTestObject('Object Repository/Page_Healios Platform/p_Permissions'), 'Permissions')

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Healios Platform/button_Back'), 0)

WebUI.verifyElementClickable(findTestObject('Object Repository/Page_Healios Platform/button_Back'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Healios Platform/button_Create Role'), 0)

WebUI.verifyElementClickable(findTestObject('Object Repository/Page_Healios Platform/button_Create Role'))
