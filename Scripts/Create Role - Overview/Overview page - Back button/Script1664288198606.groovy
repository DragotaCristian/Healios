...
WebUI.click(findTestObject('Object Repository/Page_Healios Platform/button_Back'))

WebUI.click(findTestObject('Object Repository/Page_Healios Platform/div_Create new Role'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Healios Platform/div_Create new Role'), 0)
