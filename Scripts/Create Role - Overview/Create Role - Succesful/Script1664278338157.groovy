...
not_run: WebUI.setText(findTestObject('Object Repository/Page_Healios Platform/input_Role Name___BVID__1238'), 'Administrator')
...
WebUI.click(findTestObject('Object Repository/Page_Healios Platform/button_Create Role'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Healios Platform/p_Role created successfully'), 0)

WebUI.verifyElementText(findTestObject('Object Repository/Page_Healios Platform/p_Role created successfully'), 'Role created successfully.')
